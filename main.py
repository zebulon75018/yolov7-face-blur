...
def convert_nparray_to_QPixmap(img):
    ...
    qimg = QImage(img.data, w, h, w*ch, QImage.Format_BGR888) 
        ...
        for url in event.mimeData().urls():
            if url.isLocalFile():
                ...
                with torch.no_grad():   
                        ...
                        if  image is None:
                            return
                        pix =convert_nparray_to_QPixmap(image)                        
                        self.setPixmap( pix )
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('Image Blur Faces')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='yolov7-face.pt', help='model.pt path(s)')
